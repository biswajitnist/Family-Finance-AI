...
export interface Transaction {
  ...
  loan_ledger_type: string | null;
  loan_balance_effect: string | null;
  loan_principal_component: string | null;
  loan_interest_component: string | null;
  loan_mapping_confidence: string | null;
  loan_user_confirmed: boolean;
...
export type ResourceRecord = Record<
  string,
  string | number | boolean | null | ResourceRecord[] | Record<string, unknown>[]
>;
